...
class DefaultPreprocessor(object):
    ...
    def run(
        ...
        plans_file = join(
            paths.nnUNet_preprocessed, dataset_name, plans_identifier + ".json"
        )
        ...
        dataset_json_file = join(
            paths.nnUNet_preprocessed, dataset_name, "dataset.json"
        )
        ...
        dataset = get_filenames_of_train_images_and_targets(
            join(paths.nnUNet_raw, dataset_name), dataset_json
        )
