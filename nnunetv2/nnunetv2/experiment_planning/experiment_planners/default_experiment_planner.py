...
class ExperimentPlanner(object):
    ...
    def determine_normalization_scheme_and_whether_mask_is_used_for_norm(
        ...
        if self.dataset_fingerprint["median_relative_size_after_cropping"] < (
            3 / 4.0
        ) or self.dataset_json.get("use_mask_for_norm"):
    ...
    def save_plans(self, plans):
        ...
        print(
            f"Plans were saved to {join(paths.nnUNet_preprocessed, self.dataset_name, self.plans_identifier + '.json')}"
        )
