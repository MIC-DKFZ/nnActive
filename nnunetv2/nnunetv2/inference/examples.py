...
if __name__ == "__main__":
    ...
    predictor.initialize_from_trained_model_folder(
        join(
            ...
            "Dataset003_Liver/nnUNetTrainer__nnUNetPlans__3d_lowres",
        ),
        use_folds=(0,),
    ...
    predictor.predict_from_files(
        join(paths.nnUNet_raw, "Dataset003_Liver/imagesTs"),
    ...
    img, props = SimpleITKIO().read_images(
        [join(paths.nnUNet_raw, "Dataset003_Liver/imagesTs/liver_147_0000.nii.gz")]
    )
    img2, props2 = SimpleITKIO().read_images(
        [join(paths.nnUNet_raw, "Dataset003_Liver/imagesTs/liver_146_0000.nii.gz")]
    )
    img3, props3 = SimpleITKIO().read_images(
        [join(paths.nnUNet_raw, "Dataset003_Liver/imagesTs/liver_145_0000.nii.gz")]
    )
    img4, props4 = SimpleITKIO().read_images(
        [join(paths.nnUNet_raw, "Dataset003_Liver/imagesTs/liver_144_0000.nii.gz")]
    )
