...
from nnunetv2.utilities.helpers import DummyMetricWriter, dummy_context, empty_cache
...
class nnUNetPredictor(object):
    ...
    def predict_from_data_iterator(
        ...
        if self.log_times is not None:
            self.log_times.write_metric(
                mean_prediction_time_s, "mean_prediction_time_s"
            )
        return ret
...
if __name__ == "__main__":
    ...
    img, props = SimpleITKIO().read_images(
        [join(paths.nnUNet_raw, "Dataset003_Liver/imagesTr/liver_63_0000.nii.gz")]
    )
