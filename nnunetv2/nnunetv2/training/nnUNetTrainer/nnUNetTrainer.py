...
class nnUNetTrainer(object):
    def __init__(
        ...
        self.preprocessed_dataset_folder_base = (
            join(paths.nnUNet_preprocessed, self.plans_manager.dataset_name)
            if paths.nnUNet_preprocessed is not None
            else None
        )
        self.output_folder_base = (
            ...
            if paths.nnUNet_results is not None
            else None
        )
    ...
    def perform_actual_validation(
        self, save_probabilities: bool = False, clean_val_folder: bool = True
    ):
