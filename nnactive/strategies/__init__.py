...
def get_strategy(config: ActiveConfig, strategy_name: str, dataset_id: int, **kwargs) -> AbstractQueryMethod:
    strategy = strategydict[strategy_name].init_from_dataset_id(config, dataset_id, **kwargs)
    return strategy
