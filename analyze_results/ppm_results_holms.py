...
from nnactive.analyze.metrics import PairwisePenaltyMatrix_holms
...
for setting in USE_SETTINGS_LIST:
    ...
    for dataset in setting_data:
        ...
        for budget in setting_data[dataset]:
            ...
            for subsetting in setting_data[dataset][budget]:
                ...
                matrix = analysis.compute_pairwise_penalty_holms()
    ...
    for dataset in all_matrices:
        merged_matrix = PairwisePenaltyMatrix_holms.create_merged_matrix(
            [
                mat[subsetting]
        ...
        if len(merged_matrix.algs) == 0:
            ...
            continue
        PairwisePenaltyMatrix_holms.plot_pairwise_matrix(
            merged_matrix,
