...
## Contains
Code for reproducing all analysis in:
1. nnActive: A Framework for Evaluation of Active Learning in 3D Biomedical Segmentation
2. **Finally Beating the Random Baseline: A Simple and Effective Active Learning Method for 3D Biomedical Segmentation**
